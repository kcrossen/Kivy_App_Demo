...
class Build_Kivy_App_UI ( App ):
    ...
    def build(self):
        self.title = "Kivy App Demo Step4"
        Window.bind(on_key_down=self.on_keyboard_down)
        ...
        # Duplex screen
        self.Duplex_Upper_Payload_Box = BoxLayout(id="Duplex_Upper_Payload_Box",
                                                  orientation='vertical', size_hint=(1, 0.48))
        self.Duplex_Upper_Payload_Box.bind(on_touch_down=self.on_touch_down)
        self.Duplex_Upper_Payload_Box.bind(on_touch_move=self.on_touch_move)
        self.Duplex_Upper_Payload_Box.bind(on_touch_up=self.on_touch_up)

        self.Duplex_Lower_Payload_Box = BoxLayout(id="Duplex_Lower_Payload_Box",
                                                  orientation='vertical', size_hint=(1, 0.48))
        self.Duplex_Lower_Payload_Box.bind(on_touch_down=self.on_touch_down)
        self.Duplex_Lower_Payload_Box.bind(on_touch_move=self.on_touch_move)
        self.Duplex_Lower_Payload_Box.bind(on_touch_up=self.on_touch_up)
        ...
        # Simplex screen
        self.Simplex_Lower_Payload_Box = BoxLayout(id="Simplex_Lower_Payload_Box",
                                                   orientation='vertical', size_hint=(1, (2 * 0.48)))
        self.Simplex_Lower_Payload_Box.bind(on_touch_down=self.on_touch_down)
        self.Simplex_Lower_Payload_Box.bind(on_touch_move=self.on_touch_move)
        self.Simplex_Lower_Payload_Box.bind(on_touch_up=self.on_touch_up)
    ...
    def update ( self, *args ):
        ...
        if (self.Visible_Payload_Count == 2):
            ...
            metric_figure_widget = \
                Prepare_Get_Metric_Statistics_Figure(0,
                                                     metric_statistics_list,
                                                     graph_width, graph_height)
            ...
            metric_figure_widget = \
                Prepare_Get_Metric_Statistics_Figure(1,
                                                     metric_statistics_list,
                                                     graph_width, graph_height)
    ...
    def zoom_cloudwatch_graph ( self, Widget_List_Index,
        ...
        metric_statistics_list = \
            Get_Metric_Statistics_Datapoints(graph_widget_list_index, period_end_utc, self.Period_Duration_Hours)
    ...
    def on_touch_down ( self, instance, touch, *args ):
        if (not instance.collide_point(touch.x, touch.y)): return False
        ...
        if (instance.id == "Duplex_Upper_Payload_Box"):
            self.Touch_Down_Index = 0
        elif (instance.id == "Duplex_Lower_Payload_Box"):
            self.Touch_Down_Index = 1
        elif (instance.id == "Simplex_Lower_Payload_Box"):
            self.Touch_Down_Index = 0
        else:
    ...
    def on_touch_move ( self, instance, touch, *args ):
        ...
        if (not (((instance.id == "Duplex_Upper_Payload_Box") and (self.Touch_Down_Index == 0)) or
                 ((instance.id == "Duplex_Lower_Payload_Box") and (self.Touch_Down_Index == 1)) or
                 ((instance.id == "Simplex_Lower_Payload_Box") and (self.Touch_Down_Index == 0)))): return False
    ...
    def on_touch_up ( self, instance, touch, *args ):
        ...
        if (instance.id == "Duplex_Upper_Payload_Box"):
            self.Duplex_Upper_Payload_Box.clear_widgets()
            self.Duplex_Upper_Payload_Box.add_widget(graph_widget_list[0])

        elif (instance.id == "Duplex_Lower_Payload_Box"):
            self.Duplex_Lower_Payload_Box.clear_widgets()
            self.Duplex_Lower_Payload_Box.add_widget(graph_widget_list[1])

        elif (instance.id == "Simplex_Lower_Payload_Box"):
            self.Simplex_Lower_Payload_Box.clear_widgets()
            self.Simplex_Lower_Payload_Box.add_widget(graph_widget_list[0])
    ...
    def escape_graph_zoom ( self ):
        ...
        if (self.Touch_Down_Instance_Id == "Duplex_Upper_Payload_Box"):
            self.Duplex_Upper_Payload_Box.clear_widgets()
            self.Duplex_Upper_Payload_Box.add_widget(graph_widget_list[0])

        elif (self.Touch_Down_Instance_Id == "Duplex_Lower_Payload_Box"):
            self.Duplex_Lower_Payload_Box.clear_widgets()
            self.Duplex_Lower_Payload_Box.add_widget(graph_widget_list[1])

        elif (self.Touch_Down_Instance_Id == "Simplex_Lower_Payload_Box"):
            self.Simplex_Lower_Payload_Box.clear_widgets()
            self.Simplex_Lower_Payload_Box.add_widget(graph_widget_list[0])
    ...
    def on_start ( self, **kwargs ):
        Clock.schedule_once(self.force_update, 0.5)
        return True
